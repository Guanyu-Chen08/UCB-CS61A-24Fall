...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        distance = 0
        while True:
            if nearest_place.is_hive:
                return None
            if distance >= self.lower_bound and (self.upper_bound == -1 or distance <= self.upper_bound):
    ...
    def action(self, gamestate):
        ...
        while next_place:
            if next_place.ant == None:
                pass
            elif next_place.ant.is_container and next_place.ant.ant_contained:
                next_place.ant.ant_contained.double()
